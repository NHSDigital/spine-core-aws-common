...
"""
from spine_core_aws_common.log.spinelogging import SpineLogger
from spine_core_aws_common.log.constants import LoggingConstants as lc
from spine_core_aws_common.log.details import get_log_details
from spine_core_aws_common.log.formatting import (add_default_keys,
                            create_log_preamble,
                            create_placehold_log,
                            evaluate_log_keys,
                            substitute_preamble_for_monitor)
from spine_core_aws_common.log.masking import mask_url
from spine_core_aws_common.log.writer import write_to_file


def write_log(
        log_reference='IGUTI9999',
        error_list=None,
        log_row_dict=None,
