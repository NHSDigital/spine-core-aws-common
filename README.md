...
```
pip install https://github.com/NHSDigital/spine-core-aws-common/releases/download/v0.0.3/spine_aws_common-0.0.3-py3-none-any.whl
```

### requirements.txt

```
https://github.com/NHSDigital/spine-core-aws-common/releases/download/v0.0.3/spine_aws_common-0.0.3-py3-none-any.whl
```

### Poetry

```
poetry add https://github.com/NHSDigital/spine-core-aws-common/releases/download/v0.0.3/spine_aws_common-0.0.3-py3-none-any.whl
```
